...
public:    
    void testBooleanLogic(){
        ...
        std::set< uint > s1; s1.insert( 1 ); s1.insert( 2 ); s1.insert( 3 ); s1.insert( 4 );
        std::set< uint > s2; s2.insert( 0 ); s2.insert( 2 ); s2.insert( 3 ); s2.insert( 5 );  
        std::set< uint > s3; s3.insert( 1 ); s3.insert( 2 ); s3.insert( 6 ); s3.insert( 5 );
        std::set< uint > s4; s4.insert( 0 ); s4.insert( 2 ); s4.insert( 3 ); s4.insert( 4 );    
        ...
        std::vector < std::set < uint > > setVec;
        setVec.push_back( s1 );
        setVec.push_back( s2 );
        setVec.push_back( s3 );
        setVec.push_back( s4 );
