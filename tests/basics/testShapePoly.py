...
def findShapeFunction( uN, dim, nCoeff, pnts, pascale, serendipity ): 
    ...
    inv = g.RInversion( uN, fop, True, True )
...
E2_1_R = g.RPolynomialFunction( g.asvector( e1 ) )
E2_2_R = g.RPolynomialFunction( g.asvector( e2 ) )
E2_1_S = g.RPolynomialFunction( g.RVector(), g.asvector( e1 ) )
E2_2_S = g.RPolynomialFunction( g.RVector(), g.asvector( e2 ) )
E2_1_T = g.RPolynomialFunction( g.RVector(), g.RVector(), g.asvector( e1 ) )
E2_2_T = g.RPolynomialFunction( g.RVector(), g.RVector(), g.asvector( e2 ) )

E3_1_R = E2_1_R * ( E2_1_R - E2_2_R )
E3_2_R = E2_2_R * ( E2_2_R - E2_1_R )
E3_3_R = 4. * ( E2_1_R * E2_2_R )

E3_1_S = E2_1_S * ( E2_1_S - E2_2_S )
E3_2_S = E2_2_S * ( E2_2_S - E2_1_S )
E3_3_S = 4. * ( E2_1_S * E2_2_S )
...
H8_1 = E2_1_R * E2_1_S * E2_1_T
H8_2 = E2_2_R * E2_1_S * E2_1_T
H8_3 = E2_2_R * E2_2_S * E2_1_T
H8_4 = E2_1_R * E2_2_S * E2_1_T
H8_5 = E2_1_R * E2_1_S * E2_2_T
H8_6 = E2_2_R * E2_1_S * E2_2_T
H8_7 = E2_2_R * E2_2_S * E2_2_T
H8_8 = E2_1_R * E2_2_S * E2_2_T
...
N = findShapeFunction( uN, dim, nCoeff, pnts, pascale, serendipity)
...
print 'H8_1', H8_1
print 'H8_1', Q4_1 * E2_1_T

print 'H8_2', H8_2
print 'H8_2', Q4_2 * E2_1_T

print 'H8_5', H8_5
print 'H8_5', Q4_1 * E2_2_T
