% adds paths for GIMLab (GIMLi matlab) toolboxes
...
addpath([pwd filesep 'plot']);    % plot tools
addpath([pwd filesep 'poly']);    % poly file generation
addpath([pwd filesep 'trans']);   % transformation functions
