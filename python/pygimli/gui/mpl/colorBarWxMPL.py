...
class ColorBarWxMPL(ManagedProperties):
    ...
    def createPropertyPanel(self, panel=None):
        ...
        if panel:
            ...
            self.activeCheck = self.appendProperty(
                "cbActive",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarActiveCheckBox'),
                ctrlEvent=wx.EVT_CHECKBOX,
                targetFunct=self.activator)
            self.cbarTicks = self.appendProperty(
                "cbNTicks",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarTicksSpinCtrl'),
                ctrlEvent=wx.EVT_TEXT,
                default=5,
                targetFunct=self.update)
            self.nColors = self.appendProperty(
                "cbNColors",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarNColorsTextCtrl'),
            ...
            self.cmin = self.appendProperty(
                "cbCmin",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarCminTextCtrl'),
                ctrlEvent=wx.EVT_KILL_FOCUS,
                valType=float,
                targetFunct=self.update)
            self.cmax = self.appendProperty(
                "cbCmax",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarCmaxTextCtrl'),
                ctrlEvent=wx.EVT_KILL_FOCUS,
                valType=float,
                targetFunct=self.update)
            self.cAuto = self.appendProperty(
                "cbAuto",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarAutoColorCheckBox'),
                ctrlEvent=wx.EVT_CHECKBOX,
                targetFunct=self.autoColor)
            self.logScale = self.appendProperty(
                "cbLogScale",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarLogCheckBox'),
                ctrlEvent=wx.EVT_CHECKBOX,
                targetFunct=self.setLogScale)
            # better to set the following nativ through a propertygrid
            self.label = self.appendProperty(
                "cbLabel",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarLabelTextCtrl'),
                ctrlEvent=wx.EVT_KILL_FOCUS,
                targetFunct=self.update)
            self.horizontal = self.appendProperty(
                "cbHoriz",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarHorizRadioButton'),
                ctrlEvent=wx.EVT_RADIOBUTTON,
                targetFunct=self.update)
            self.vertical = self.appendProperty(
                "cbVert",
                ctrl=wx.xrc.XRCCTRL(
                    panel,
                    'piColorBarVertRadioButton'),
                ctrlEvent=wx.EVT_RADIOBUTTON,
                targetFunct=self.update)
        else:
