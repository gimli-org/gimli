...
class MainFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.listCtrlCombo = ListCtrlComboPopupControl(self, style=wx.CB_READONLY | wx.CB_DROPDOWN  # |wx.NO_BORDER
                                                       , size=(87, -1))

        self.listCtrlCombo.addItems(['item1', 'item2'])
        self.sizer_.Add(self.listCtrlCombo, 0, wx.EXPAND)

        self.checkListBoxCombo = CheckListBoxComboPopupControl(self, style=wx.CB_READONLY | wx.CB_DROPDOWN  # |wx.NO_BORDER
                                                               , size=(87, -1))
