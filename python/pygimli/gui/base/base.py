...
class AppResource(ManagedProperties):
    ...
    def createPropertyInspectorNoteBookPanel(self, parent,
                                             panelName, title=None):
        """
...
#
    ...
    def createMenuItem(self, menu, name="", help="auto",
                       function=None, bitmap=None):
        """
            What is this?
