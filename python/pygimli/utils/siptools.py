...
class DoubleColeColeModelling(g.ModellingBase):
    """
...
def ReadAndRemoveEM(filename, readsecond=False, doplot=False,
    ...
    # inversion
    inv = g.RInversion(phi, f, True, False)
    inv.setAbsoluteError(phi * ePerc * 0.01 + ePhi / 1000.)
    inv.setRobustData(True)
#    inv.setCWeight(g.RVector(6, 1.0)) # wozu war das denn gut?
