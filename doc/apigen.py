...
The authors of pygimli have modified this file from the scikit-image project:
https://github.com/scikit-image/scikit-image/blob/master/doc/tools/apigen.py
"""
