...
Gimli provide a collection of tools for mesh generation. Easy grid generation is build in but we provide also some wrapper for unstructured meshs. e.g. :term:`triangle` and :term:`tetgen`. Incorporation of other generators should be straight forward, e.g., :py:mod:`pygimli.meshtools`
"""
...
For instance, you can iterate through all elements of type :gimliapi:`GIMLI::Cell`, which also provide a lot of methods:
