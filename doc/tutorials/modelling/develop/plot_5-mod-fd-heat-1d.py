...
u0 = np.zeros(len(x)); u0[sourcePosID] = 1.
...
ax1.plot(x, uG[timeProbeID], label='Analytical at ' + str(t[timeProbeID]) + ' s')
ax2.plot(t, uG[:,spaceProbeID], label='Analytical at ' + str(x[spaceProbeID]) + ' m')
...
ax1.plot(pg.x(grid.cellCenters()), uFVM[timeProbeID], '.-', label='FV implicit')
