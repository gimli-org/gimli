...
This tutorial shows how to treat the simplest inversion case with an own forward calculation.
As linear regression is the easiest inverse problem we start with fitting a polynomial of degree :math:`P`
